        ...
        <div className="flex flex-col-reverse md:flex-row items-center">
          <div className="md:w-1/2 space-y-6 text-center md:text-left pt-8 md:pt-0">
            <div className="mb-6 inline-block">
              <div className="flex items-center space-x-2 bg-divino-purple/10 text-divino-purple rounded-full px-4 py-1 text-sm font-medium mb-4">
                <Cross size={14} />
                <span>Artigos Religiosos de Qualidade</span>
              </div>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 leading-tight font-playfair">
              Encontre Paz e <span className="text-divino-purple">Fé</span> em Nossa Loja
            </h1>
            <p className="text-lg md:text-xl text-gray-600 max-w-lg">
              Descubra nossa coleção de artigos religiosos católicos feitos com cuidado e devoção para enriquecer sua jornada espiritual.
            </p>
          ...
          <div className="md:w-1/2 flex justify-center md:justify-end">
            <div className="relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1613922968445-1e83347d2d86?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80" 
                alt="Imagem de artigos religiosos" 
              ...
              <div className="absolute -bottom-5 -right-5 md:bottom-10 md:-right-10 bg-white rounded-lg shadow-lg p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium text-gray-800">Em Estoque</span>
                </div>
                <p className="text-sm text-gray-600 mt-1">Produtos exclusivos</p>
              </div>
            </div>
          </div>
        </div>
