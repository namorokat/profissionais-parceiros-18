      ...
      <div className="container">
        <div className="space-y-8">
          ...
          <div className="md:hidden relative rounded-2xl overflow-hidden shadow-xl aspect-video">
            ...
            <img alt="Posicionamento Google" src="/lovable-uploads/336d62ea-22aa-46a1-9a12-7c6748232b7e.png" className="w-full h-full object-contain opacity-90" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:block relative rounded-2xl overflow-hidden shadow-xl aspect-video">
              <div className="absolute inset-0 flex items-center justify-center bg-[#332004]"></div>
              <img alt="Posicionamento Google" src="/lovable-uploads/336d62ea-22aa-46a1-9a12-7c6748232b7e.png" className="w-full h-full object-contain opacity-80" />
            </div>
          </div>
        </div>
      </div>
